...
export default function ResourcesPage() {
  ...
  return (
    <div className="min-h-screen bg-[url('/images/lima-city-3d.jpg')] bg-cover bg-center relative">
      ...
      <div className="relative z-10 min-h-screen">
        ...
        <div className="grid grid-cols-12 gap-4 p-4 h-[calc(100vh-140px)]">
          ...
          <div className="col-span-3 space-y-4 overflow-y-auto">
            ...
            <ZonePanel title="Residencial" color="bg-blue-400" sites={8} area={7} coverange={50} />
