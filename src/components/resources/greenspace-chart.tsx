...
export function GreenspaceChart() {
  return (
    <div className="!bg-slate-900/80 !rounded-lg !p-4">
      <h2 className="!text-white !font-bold !text-lg !mb-4">Greenspace Ratio</h2>
      <div className="!flex !items-center !justify-center">
        ...
        <div className="!ml-4 !space-y-2">
          <div className="!flex !items-center !gap-2">
            ...
            <span className="!text-white !text-sm">Greenspace</span>
          </div>
          <div className="!flex !items-center !gap-2">
            <div className="!w-3 !h-3 !bg-blue-500 !rounded-sm"></div>
            <span className="!text-white !text-sm">Developed</span>
          </div>
        </div>
      </div>
    </div>
