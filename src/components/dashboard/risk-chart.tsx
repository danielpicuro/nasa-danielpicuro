...
export function RiskChart() {
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-6">
      <div className="mb-4">
        <h3 className="text-lg font-semibold text-cyan-400">Risk Reduction vs. Intervention</h3>
        <p className="text-sm text-muted-foreground">Projected evolution of flood risk</p>
      </div>
