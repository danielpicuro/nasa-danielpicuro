...
export function ComparisonCard({ before, after }: ComparisonCardProps) {
  ...
  const t = translations[language].twin3d.comparisonCard;
  ...
  return (
    ...
    >
      <div className="!grid !grid-cols-2 !gap-6 !mb-6">
        ...
        <div className="!border-r !border-gray-700 !pr-6">
          <div className="!flex !items-center !gap-2 !mb-4">
            ...
            <h3 className="!text-xl !font-bold !text-orange-500">{t.before.title}</h3>
          </div>
          <div className="!space-y-3">
            <div className="!flex !justify-between !items-center">
              <span className="!text-gray-300">{t.before.floodRisk}</span>
              <span className="!text-red-500 !font-bold">{before.floodRisk}</span>
            </div>
            <div className="!flex !justify-between !items-center">
              <span className="!text-gray-300">{t.before.affectedPopulation}</span>
              <span className="!text-white !font-bold">{before.affectedPopulation}</span>
            </div>
            <div className="!flex !justify-between !items-center">
              <span className="!text-gray-300">{t.before.annualDamage}</span>
        ...
        <div className="!pl-6">
          <div className="!flex !items-center !gap-2 !mb-4">
            ...
            <h3 className="!text-xl !font-bold !text-green-500">{t.after.title}</h3>
          </div>
          <div className="!space-y-3">
            <div className="!flex !justify-between !items-center">
              <span className="!text-gray-300">{t.after.floodRisk}</span>
              <span className="!text-yellow-500 !font-bold">{after.floodRisk}</span>
            </div>
            <div className="!flex !justify-between !items-center">
              <span className="!text-gray-300">{t.after.affectedPopulation}</span>
              <span className="!text-white !font-bold">{after.affectedPopulation}</span>
            </div>
            <div className="!flex !justify-between !items-center">
              <span className="!text-gray-300">{t.after.annualDamage}</span>
      ...
      <div className="!flex !items-center !justify-between !pt-4 !border-t !border-gray-700">
        <p className="!text-purple-400 !font-medium">{t.aiPowered}</p>
